...
<head>
    ...
    <title>Blog de Marina Do</title>
    <style>
        * { box-sizing: border-box; }
        body { font-family: Arial, sans-serif; background:#f4f4f4; color:#222; margin:0; line-height:1.6; }
        header { background:#B7791F; color:white; padding:30px; text-align:center; }
        nav { margin-top:18px; }
        ...
        footer { background:#B7791F; color:white; text-align:center; padding:20px; }
...
<body>
    ...
    <main id="inicio">
        <section id="posts">
            <article>
                ...
                <p>Publicado por Marina Do Livramento Macêdo</p>
                <p><strong>RA:</strong> 79395231165</p>
        ...
        <aside id="sobre">
            <h3>Sobre mim</h3>
            <p>Meu nome é Marina Do Livramento Macêdo e este blog foi criado para praticar desenvolvimento web.</p>
            <h3>Categorias</h3>
            <ul>
                <li>Estudos</li>
                <li>Tecnologia</li>
    ...
    <footer><p>© <span id="anoAtual"></span> Blog de Marina Do</p></footer>
    ...
    <script>
        ...
        botaoMensagem.addEventListener("click", function() {
            mensagem.textContent = "Olá! Você está visitando o blog de Marina Do!";
        });
