...
<head>
    ...
    <title>Blog de Francisco Renato</title>
    <style>
        * { box-sizing: border-box; }
        body { font-family: Arial, sans-serif; background:#f4f4f4; color:#222; margin:0; line-height:1.6; }
        header { background:#3F51B5; color:white; padding:30px; text-align:center; }
        nav { margin-top:18px; }
        ...
        footer { background:#3F51B5; color:white; text-align:center; padding:20px; }
...
<body>
    <header>
        <h1>Blog de Francisco Renato</h1>
    ...
    <main id="inicio">
        <section id="posts">
            <article>
                ...
                <p>Publicado por Francisco Renato De Carvalho</p>
                <p><strong>RA:</strong> 51695155670</p>
        ...
        <aside id="sobre">
            <h3>Sobre mim</h3>
            <p>Meu nome é Francisco Renato De Carvalho e este blog foi criado para praticar desenvolvimento web.</p>
            <h3>Categorias</h3>
            <ul>
                <li>Estudos</li>
                <li>Tecnologia</li>
    ...
    <footer><p>© <span id="anoAtual"></span> Blog de Francisco Renato</p></footer>
    ...
    <script>
        ...
        botaoMensagem.addEventListener("click", function() {
            mensagem.textContent = "Olá! Você está visitando o blog de Francisco Renato!";
        });
