...
<head>
    ...
    <title>Blog de Jamily Lustosa</title>
    <style>
        * { box-sizing: border-box; }
        body { font-family: Arial, sans-serif; background:#f4f4f4; color:#222; margin:0; line-height:1.6; }
        header { background:#C05621; color:white; padding:30px; text-align:center; }
        nav { margin-top:18px; }
        ...
        footer { background:#C05621; color:white; text-align:center; padding:20px; }
...
<body>
    ...
    <main id="inicio">
        <section id="posts">
            <article>
                ...
                <p>Publicado por Jamily Lustosa Da Silva</p>
                <p><strong>RA:</strong> 73534351479</p>
        ...
        <aside id="sobre">
            <h3>Sobre mim</h3>
            <p>Meu nome é Jamily Lustosa Da Silva e este blog foi criado para praticar desenvolvimento web.</p>
            <h3>Categorias</h3>
            <ul>
                <li>Estudos</li>
                <li>Tecnologia</li>
    ...
    <footer><p>© <span id="anoAtual"></span> Blog de Jamily Lustosa</p></footer>
    ...
    <script>
        ...
        botaoMensagem.addEventListener("click", function() {
            mensagem.textContent = "Olá! Você está visitando o blog de Jamily Lustosa!";
        });
