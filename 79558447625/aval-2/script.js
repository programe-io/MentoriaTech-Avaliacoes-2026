...
const meusPosts = [
    {
        ...
        // TAG IMG CORRIGIDA COM URL DE IMAGEM REAL (ANIME/NINJA/SHADOW)
    ...
    },
    {
        ...
        categoria: "teorias",
        // TAG IMG CORRIGIDA COM URL DE IMAGEM REAL (JAPANESE TEMPLE/MYSTERY)
        imagem: "https://unsplash.com",
    ...
    },
    {
        ...
        // TAG IMG CORRIGIDA COM URL DE IMAGEM REAL (RAMEN/FOOD)
        imagem: "https://unsplash.com",
...
function mostrarPosts(lista) {
    ...
    lista.forEach(post => {
        // A TAG IMG ABAIXO AGORA VAI CARREGAR AS IMAGENS CORRETAMENTE
        painel.innerHTML += `
