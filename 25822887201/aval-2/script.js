...
let nome = "João";
const PI = 3.14159;
var idade = 25; // var ainda funciona, mas let/const é recomendado
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (titulo) titulo.textContent = "Título alterado pelo JavaScript";

    const btn = document.getElementById("btnClique");
    if (btn) {
        btn.addEventListener("click", () => {
            alert("Você clicou no botão!");
            if (titulo) titulo.style.color = "red";
        });
    }
...
// ============================
// Animações Simples com requestAnimationFrame
// ============================
let pos = 0;
function moverCaixa() {
