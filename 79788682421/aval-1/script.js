...
<head>
    ...
    <title>Blog de Isabele Santos</title>
    <style>
        * { box-sizing: border-box; }
        ...
        footer { background:#4A5568; color:white; text-align:center; padding:20px; }
...
<body>
    ...
    <main id="inicio">
        <section id="posts">
            <article>
                ...
                <p>Publicado por Isabele Santos De Sousa Borges</p>
                <p><strong>RA:</strong> 79788682421</p>
        ...
        <aside id="sobre">
            <h3>Sobre mim</h3>
            <p>Meu nome é Isabele Santos De Sousa Borges e este blog foi criado para praticar desenvolvimento web.</p>
            <h3>Categorias</h3>
            <ul>
                <li>Estudos</li>
                <li>Tecnologia</li>
    ...
    <footer><p>© <span id="anoAtual"></span> Blog de Isabele Santos</p></footer>
    ...
    <script>
        ...
        botaoMensagem.addEventListener("click", function() {
            mensagem.textContent = "Olá! Você está visitando o blog de Isabele Santos!";
        });
